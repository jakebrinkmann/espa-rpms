...
%define tagname laads_hotrelease
...
Requires:	espa-surface-reflectance >= 1.0.5
...
# ----------------------------------------------------------------------------
%changelog
* Mon Apr 10 2017 Ronald D Dilley <ronald.dilley.ctr@usgs.gov>
- Initial Version for ESPA 2.17.0.aux
